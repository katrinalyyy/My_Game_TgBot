"""
Запуск приложения с Swagger документацией
"""
import os
...
if __name__ == "__main__":
    print("🚀 Запуск приложения с Swagger...")
    ...
    try:
        ...
        print(f"📚 Swagger документация: http://{host}:{port}/api/docs")
        print(f"🔍 API информация: http://{host}:{port}/")
